      ...
      <nav className="sidebar-nav">
        ...
        <div className="nav-section">
          ...
          <ul>
            ...
            <li>
              <Link to="/conversation/tinyteams" className={location.pathname.includes('/conversation/') ? 'active' : ''}>
                <svg className="icon" viewBox="0 0 24 24" fill="currentColor">
            ...
            {/* Link de configurações aparece apenas na página da empresa */}
            {isEmpresaPage && empresaSlug && (
              <li>
                <Link to={`/admin/${empresaSlug}/configuracoes`} className={location.pathname.includes('/configuracoes') ? 'active' : ''}>
                  <svg className="icon" viewBox="0 0 24 24" fill="currentColor">
